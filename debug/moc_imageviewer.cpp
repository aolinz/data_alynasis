...
QT_MOC_LITERAL(1, 12, 10), // "signalSend"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "ImageViewer\0signalSend\0"
};
...
static const uint qt_meta_data_ImageViewer[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::Int, QMetaType::Int, QMetaType::Float, QMetaType::QString,    2,    2,    2,    2,
...
void ImageViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalSend((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< float(*)>(_a[3])),(*reinterpret_cast< QString(*)>(_a[4]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ImageViewer::*)(int , int , float , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ImageViewer::signalSend)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ImageViewer::signalSend(int _t1, int _t2, float _t3, QString _t4)
{
